...
<head>
    ...
    <title>Tektik Admin Login</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <form method="POST" action="{{ route('admin_login_admin') }}">
                  @csrf
                  <div class="form-group @error('login_type') has-danger @enderror">
                    <label>Username or Email *</label>
                    <input name="login_type" type="text" class="form-control p_input @error('login_type') form-control-danger @enderror">
                    @error('login_type')
                  ...
                  <p class="sign-up">Don't have an Account?<a href="{{ route('admin_register') }}"> Sign Up</a></p>
                </form>
              </div>
            </div>
          </div>
