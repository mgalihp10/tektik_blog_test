...
<main class="form-signin w-100 m-auto">
  <form method="POST" action="{{ route('check_login') }}">
    ...
    <div class="form-floating @error('login_type') has-validation @enderror">
      <input type="text" class="form-control @error('login_type') is-invalid @enderror" id="loginTypeInput" placeholder="Username or Email" name="login_type">
      <label for="loginTypeInput">Username or Email address</label>
      @error('login_type')
    ...
    <p class="sign-up">Don't have an Account?<a href="{{ route('register_user') }}"> Sign Up</a></p>
